...
class Post
{
    ...
    public function getPublierLe(): ?\DateTimeInterface
    {
        return $this->publierLe;
    }

    public function setPublierLe(\DateTimeInterface $publierLe): self
    {
    ...
    public function setPracticien(string $practicien): self
    {
